...
`,
                styles: [`:host{width:auto;float:left;display:table;height:100%;margin:0 0 0 10px;font-size:14px;font-weight:300;font-family:Poppins;-webkit-font-smoothing:antialiased}`],
                animations: [fadeUp()]
            },] },
];
/** @nocollapse */
...
class MainToolbarProfileComponent {
    ...
    clickMenu(e) {
        ...
        const config = new OverlayConfig({
            ...
            positionStrategy: this.overlay
                .position()
                .connectedTo(this.menu.elementRef, { originX: 'start', originY: 'bottom' }, { overlayX: 'start', overlayY: 'top' })
                .withOffsetX(-265)
        });
        /** @type {?} */
        const overlayRef = this.overlay.create(config);
...
MainToolbarProfileComponent.decorators = [
  ...
  <span class="right-menu-link-picture m--img-rounded m--marginless m--img-centered">
    <span class='image-profile' [ngStyle]="imageProfileClass"></span>
  </span>
 ...
 * @suppress {checkTypes,extraRequire,uselessCode} checked by tsc
 */
class MainToolbarStartShortcutComponent {
    /**
     * @param {?} dialog
     */
    constructor(dialog) {
...
MainToolbarStartShortcutComponent.decorators = [
    { type: Component, args: [{
...
/** @nocollapse */
MainToolbarStartShortcutComponent.ctorParameters = () => [
    { type: MatDialog }
];
MainToolbarStartShortcutComponent.propDecorators = {
    clickMenu: [{ type: HostListener, args: ['click',] }]
};
...
export { HdUploadModule, HdLayoutModule, HdLoginModule, HdContextMenuModule, LayoutService, MenuService, ContextMenu, TableAdapter, routerTransition, slideToRight, slideToLeft, slideToUp, slideToDown, fadeUp, ringing, ContextMenuPanelComponent as ɵbd, ContextMenuDirective as ɵbe, ContextMenuService as ɵbf, BreadcrumbComponent as ɵh, LayoutComponent as ɵd, MainToolbarChatComponent as ɵo, MainToolbarLeftMenuComponent as ɵj, MainToolbarMenuItemComponent as ɵl, MainToolbarNotificationComponent as ɵm, MainToolbarProfileComponent as ɵn, ProfileButtonComponent as ɵs, ProfileItemComponent as ɵp, ProfileListComponent as ɵt, ProfileSectionComponent as ɵr, ProfileSeparatorComponent as ɵq, MainToolbarRightMenuComponent as ɵk, MainToolbarStartShortcutComponent as ɵx, MainToolbarComponent as ɵe, PageToolbarComponent as ɵf, SidenavItemComponent as ɵy, SidenavComponent as ɵg, StartPageDialogComponent as ɵw, StartPageComponent as ɵi, TimelineItemComponent as ɵv, TimelineComponent as ɵu, UploadContainerComponent as ɵc, UploadFileDirective as ɵa, UploadImageDirective as ɵb, LeftSideComponent as ɵba, LoginFormComponent as ɵbc, LoginComponent as ɵz, RightSideComponent as ɵbb };
