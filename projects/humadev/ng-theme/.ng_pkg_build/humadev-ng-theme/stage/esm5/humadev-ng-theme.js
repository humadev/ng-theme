...
LayoutService.ngInjectableDef = defineInjectable({ factory: function LayoutService_Factory() { return new LayoutService(); }, token: LayoutService, providedIn: "root" });
var MenuService = /** @class */ (function () {
    function MenuService(router, activeRoute, loc, _ls) {
        var _this = this;
        this.router = router;
        ...
        this.router.events
            ...
            return event;
        }), filter(function (event) { return event instanceof NavigationEnd; }), map(function () { return _this.activeRoute; }), map(function (route) {
...
MenuService.ngInjectableDef = defineInjectable({ factory: function MenuService_Factory() { return new MenuService(inject(Router), inject(ActivatedRoute), inject(Location), inject(LayoutService)); }, token: MenuService, providedIn: "root" });
...
var SidenavComponent = /** @class */ (function () {
    function SidenavComponent(render, ref, router, activeRoute, menuService, layoutService, breakpointObserver) {
        var _this = this;
        this.render = render;
        this.ref = ref;
        this.router = router;
    ...
    SidenavComponent.prototype.checkGroupAccess = function (menu, asal) {
        ...
        if (menu &&
            ...
            var allowed = intersection(menu.data.groupAccess.permissions, menu.data.groupAccess.groups).length > 0
                ? true
                : false;
            if (allowed) {
                return true;
...
var MainToolbarComponent = /** @class */ (function () {
    function MainToolbarComponent(menuService, renderer, elRef, layout, router, breakpointObserver) {
        this.menuService = menuService;
...
var MainToolbarLeftMenuComponent = /** @class */ (function () {
    function MainToolbarLeftMenuComponent(overlay, menuService, dialog) {
...
var MainToolbarNotificationComponent = /** @class */ (function () {
    function MainToolbarNotificationComponent(overlay, _render, _layout) {
        this.overlay = overlay;
...
var MainToolbarProfileComponent = /** @class */ (function () {
    function MainToolbarProfileComponent(overlay, ls) {
        this.overlay = overlay;
        this.ls = ls;
    }
...
var SidenavItemComponent = /** @class */ (function () {
    function SidenavItemComponent(router, overlay, ref, layout) {
        this.router = router;
        this.overlay = overlay;
        this.ref = ref;
        this.layout = layout;
...
var ContextMenuPanelComponent = /** @class */ (function () {
    ...
    ContextMenuPanelComponent.prototype.checkGroupAccess = function (groupAccess) {
        if (groupAccess && groupAccess.permissions && groupAccess.groups) {
            var allowed = intersection(groupAccess.permissions, groupAccess.groups).length > 0
                ? true
                : false;
            if (allowed) {
                return true;
...
var ContextMenuService = /** @class */ (function () {
    ...
    ContextMenuService.prototype.setContextMenuOverlay = function (overlay) {
    ...
    ContextMenuService.prototype.closeAllContextMenus = function () {
        if (this.contextMenu) {
            this.contextMenu.forEach(function (overlay, index) {
                overlay.detach();
                overlay.dispose();
            });
        }
...
var ContextMenuDirective = /** @class */ (function () {
    function ContextMenuDirective(ref, render, overlay, _service) {
        this.ref = ref;
        this.render = render;
        this.overlay = overlay;
    ...
    ContextMenuDirective.prototype.createPanel = function (event) {
        ...
        var contextMenu = new ComponentPortal(ContextMenuPanelComponent);
...
var TableAdapter = /** @class */ (function (_super) {
    ...
    function TableAdapter(_data, _displayedColumns, _paginator, _sort, _searchColumns, _filterInput) {
        ...
        _this.tableData = new BehaviorSubject([]);
        _this.sourceData = new BehaviorSubject([]);
        _this.displayedColumns = [];
        _this.searchColumns = [];
        _this.pagination = new BehaviorSubject({
            pageIndex: 0,
            pageSize: 10,
            length: _this.tableData.value.length
        });
        _this.filter = new BehaviorSubject('');
        _this.sort = new BehaviorSubject({
            active: '',
            direction: 'asc'
        });
    ...
    TableAdapter.prototype.connect = function () {
        ...
        return this._data.pipe(map(function (res) { return _this.setData(res); }), switchMap(function (res) {
            if (connectData.length > 0) {
                return merge.apply(void 0, __spread(connectData));
            }
            else {
                return of(res);
            }
        }), map(function () { return _this.filtering(); }), map(function () { return _this.sorting(); }), map(function () { return _this.paging(); }));
    };
